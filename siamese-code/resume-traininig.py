...
from dataset.crloader_train import get_loader

from torch.utils.tensorboard import SummaryWriter

writer = SummaryWriter('tensor2res/fc2_update_curry_pair_resnet')
    ...
    for i, (ego_frame, front_frame, ego_optical, front_optical, target) in enumerate(train_loader):
        ...
        if i % 4000 == 0 and i is not 0:
            torch.save(model.state_dict(), os.path.join(args.model_path,
                                                        'fc2-update-two-stream-twores_easy_multi-{}-iter-{}.ckpt'.format(
                                                            epoch + 1, str(i))))
        ...
        if i % 100 == 0 and i is not 0:  # every 1000 mini-batches...
            ...
            writer.add_scalar('TrainingWithFC2 curry pair loss',
                              running_loss / 100,
...
def main():
    ...
    checkpoint = torch.load('/home/adhamanaskar/Research/Siamese_Ameya/checkpoint_easyfc2update/001_checkpoint.pth.tar')
